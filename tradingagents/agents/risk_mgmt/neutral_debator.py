...
def create_neutral_debator(llm):
    def neutral_node(state) -> dict:
        ...
        prompt = f"""You are the Neutral Risk Analyst. Provide a balanced assessment of the trader's decision, challenging both the aggressive and conservative arguments where each is one-sided. Write a compact handoff, at most 180 words: proposed action/size, two sourced facts, strongest counter-evidence, invalidation trigger, and missing data. Carry forward any unresolved material objection from earlier rounds.
